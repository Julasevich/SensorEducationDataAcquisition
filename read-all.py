...
def main():
    ...
    try:
        cursor.execute('''
            CREATE TABLE IF NOT EXISTS b827eb06efa4(ID int NOT NULL AUTO_INCREMENT PRIMARY KEY, dateNow varchar(20), timeNow varchar(20), temperature FLOAT,
    ...
    try:
        while(repeat > count):
            if sensor.get_sensor_data():
                ...
                saveToDB = ("INSERT INTO b827eb06efa4"
